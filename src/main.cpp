...
unsigned int nStakeMinAge = 6 * 24 * nOneHour; // 0.25 days as zero time weight
...
const string strMessageMagic = "FazzCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("FazzCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in FazzCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // FazzCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FazzCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Fazz Genesis";
        CTransaction txNew;
        txNew.nTime = 1489091153;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1489091153;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2628659; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xbb, 0xf8, 0xec, 0xf3 };
