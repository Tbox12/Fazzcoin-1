...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FAZZ");
    case mBTC: return QString("mFAZZ");
    case uBTC: return QString::fromUtf8("μFAZZ");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("FazzCoins"));
    case mBTC: return QString(QObject::tr("Milli-FazzCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-FazzCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
